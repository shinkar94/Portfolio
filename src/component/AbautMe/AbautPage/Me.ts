...
export const AboutPage:AboutPageType = {
    ...
    ['BSATU']: "Received a diploma of a Mechanical Engineer with a specialization in the production support of agricultural production processes",
    ['KHSHP']: "Arrived for work in KHSHP in the city of Chashniki. For half a year he worked as a chief engineer of the economy.",
    ['ARMY']: "Passing military service in the Armed Forces of the Republic of Belarus as a driver-mechanic MT-LB from 2017 to 2018. He also served two years under the contract as the commander of the department of the jamming station in electronic warfare. In his free time, he taught himself programming. HTML, CSS, JS, jQuery, PHP, Bootstrap.",
    ['BORISOVENRGO']: "Software Engineer at Borisov Power Grids. Support for internal web project. Creation of new software on the website.\n"+
    ...
    ['INCUBATOR']: "Обучение в IT-INCUBATOR на FRONTEND DEVOLOPER. (REACT,REDUX, REDUX TOOLKIT, REACT NATIVE, VUE, ANGULAR) работа как с CRA так VITE приклодное (STYLED COMPONENT, FORMIK, PRITTER, MU, BOOTSTRAP)"
}
